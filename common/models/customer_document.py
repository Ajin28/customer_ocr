...
class CustomerDocument(models.Model):
    ...
    front_image = models.FileField(upload_to="documents/" ,null=True, blank=True, default=None)
    back_image = models.FileField(upload_to="documents/", null=True, blank=True, default=None)
